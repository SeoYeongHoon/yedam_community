...
public interface PostMapper {
	...
	// 단건조회
	// --------------------------------------------
	PostVO getPostDetails(@Param("postId") int postId, @Param("boardId") int boardId);

	// --------------------------------------------
	// 조회수
	// --------------------------------------------
	int updatePostViewCNT(@Param("postId") int postId, @Param("boardId") int boardId);
	...
	// 페이지네이션
	// --------------------------------------------
	List<PostVO> getPosts(PostVO postVO, @Param("startRow") int startRow, @Param("endRow") int endRow);
